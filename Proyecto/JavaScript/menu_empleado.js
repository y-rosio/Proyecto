function mas_item(){
    ...
    function Lista_Provedores(objeto){
        if(bloque){
            ...
            <ul>
                <li>  <a href="../Paginas/PROveedores">Registro Proveedor   </a> </li>
...
function cambiarTamano() {
  ...
  if (bloqueGrande) {
    ...
    <ul class="Seleccion-Uno">
        ...
        <li id="Productos"></li>
        <li>  <a href="#">Contactar con Adminitrador      </a> </li>
        <li>  <a href="../Pagina/Historial.html">Historial       </a> </li>
    </ul>
    <hr>
    <ul class="Seleccion-Dos">
        <li id="ajuste"> <a href="#">Ajustes           </a> </li>
        <li id="ifo"> <a href="../Paginas/Mas_NEXU.html">Mas sobre nosotros</a> </li>
        <li id="ayuda"> <a href="../Pagina/ayuda.html">Ayuda             </a></li>
        <li id="condicion"> <a href="TERminosCON.html">Termino y reglamentos</a></li>
    </ul>
    </div>
    `
    mas_item()
